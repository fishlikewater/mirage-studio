...
> **Note**: This is a **post-implementation** safety net. Ideally, read the [Pre-Implementation Checklist](.cowork-flow/spec/guides/pre-implementation-checklist.md) **before** writing code.
...
|----------|---------|--------|
| [Pre-Implementation Checklist](.cowork-flow/spec/guides/pre-implementation-checklist.md) | Questions before coding | **Before** writing code |
| [Code Reuse Thinking Guide](.cowork-flow/spec/guides/code-reuse-thinking-guide.md) | Pattern recognition | During implementation |
...
**Detailed Guide**: `.cowork-flow/spec/guides/cross-layer-thinking-guide.md`
...
**Detailed Guide**: `.cowork-flow/spec/guides/code-reuse-thinking-guide.md`
